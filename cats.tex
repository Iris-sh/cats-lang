...
возвращаемого функцией значения.
 ...
 \subsection{Оператор-переключатель}
 Оператор-переключатель предназначен для выбора одного из нескольких альтернативных путей выполнения программы. Вычисление оператора-переключателя начинается с вычисления выражения, после чего управление передается оператору, помеченному константным выражением, равным вычисленному значению выражения. Выход из оператора-переключателя осуществляется оператором 'выход'. Если значение выражения не равно ни одному константному выражению, то управление передается оператору, помеченному ключевым словом 'умолчание', если он есть.


\noindent\textcolor{Green}{\syntax{%

\textcolor{Black}{\textbf{переключи}}\textcolor{Black}{\texttt{(}}\textcolor{Black}{ (<выражение>)} \textcolor{Black}{\texttt{)}}%
\textcolor{Black}{\texttt{\{}}\\
\phantom{конец}\textcolor{Black}{\textbf{случай }}\textcolor{Black}{\texttt{<}}\synt{константное выражение 1}\textcolor{Black}{\texttt{>}} \textcolor{Black}{\texttt{:}} \textcolor{Black}{\texttt{<}}\textcolor{Black}{операторы 1>   }\textcolor{Black}{\texttt{>}}\\
\phantom{конец}\textcolor{Black}{\textbf{случай }}\textcolor{Black}{\texttt{<}}\synt{константное выражение 2}\textcolor{Black}{\texttt{>}} \textcolor{Black}{\texttt{:}} \textcolor{Black}{\texttt{<}}\textcolor{Black}{операторы 2>   }\textcolor{Black}{\texttt{>}}\\
\phantom{конец}\textcolor{Black}{\textbf{... }}\\
\\
\\
\phantom{конец}\textcolor{Black}{\textbf{... }}\\
\phantom{конец}\textcolor{Black}{\textbf{случай }}\textcolor{Black}{\texttt{<}}\synt{константное выражение N}\textcolor{Black}{\texttt{>}} \textcolor{Black}{\texttt{:}} \textcolor{Black}{\texttt{<}}\textcolor{Black}{операторы N>   }\textcolor{Black}{\texttt{>}}\\
\phantom{конец}\textcolor{Black}{\texttt{[}}\synt{умолчанию }\textcolor{Black}{\texttt{:}} \textcolor{Black}{\texttt{<}}\textcolor{Black}{операторы   }\textcolor{Black}{\texttt{>}}\textcolor{Black}{\texttt{]}}\\
\textcolor{Black}{\texttt{\}}}\\
}}
